...
- [qio](https://github.com/3hunnaDev/qio-public) — collection-first, self-hosted, retrieval-first RAG platform
- [react-burger](https://github.com/3hunnaDev/react-burger) — React application project
